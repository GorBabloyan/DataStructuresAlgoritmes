...
public class ReportingAllure implements IAnnotationTransformer, ITestListener, IConfigurationListener {
...
//        Iqsoft_00_BasePage.logger.error(getTestMethodName(iTestResult) + " Test Failed");
    }
